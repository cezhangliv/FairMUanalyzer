...
private:
    ...
    */
    ...
    TGraph* g_elastic;
    TH1I* hCaseDist;
    std::vector<std::string> case_keys = {"Total","TotalECALCut","TotalHitCut","TotalTrackChiCut","TotalNTrackCut","AllLeftOverhit","golden","t0all","t0mem","t0mee","t0mmm","t0me<m","t1all","t1mem","t1mee","t1mmm","t1mmmband","t1mmmoutofband","t1me<m"};
    ...
    double CalculateXtgt(const MUonERecoOutputTrackAnalysis* track, double zTgt);
    double CalculateYtgt(const MUonERecoOutputTrackAnalysis* track, double zTgt);
    double CalculateRtgt(const MUonERecoOutputTrackAnalysis* track, double zTgt);
